...
<html>
<head>
<title>Rocket Bootstarp Website Template | About :: w3layouts</title>
   ...
   <!----start-header---->
		 <div class="header">
	       <div class="container header_top">
				<div class="logo">
                                    <a href="index.jsp"><img src="images/logo-test.png" width="80" height="55" alt=""></a>
				</div>
		  		<div class="menu">
					<a class="toggleMenu" href="#"><img src="images/nav_icon.png" alt="" /> </a>
					<ul class="nav" id="nav">
                                            <li><a href="index.php">Inicio</a></li>
                                          <li class="current"><a href="about.php">Información</a></li>
	...
	<!----- //End-header---->
     <div class="container banner">
	 	<section class="title-section">
		   ...
		   Informacion</h1>
                    <ul class="breadcrumb breadcrumb__t"><li><a href="index.php">Inicio</a></li><li class="active">About</li></ul>  
		</section>
	 </div>
	 <div class="main">
     ...
     <div class="container footer">
     	...
     	<div class="footer_bottom">
		   ...
		   <p>Derecho Reservado por:<a> Elar, Geseñi, Natalia</a></p>
                </div></marquee>
		  <ul class="social">
